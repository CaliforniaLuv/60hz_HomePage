        ...
        <>
            <div>
                ...
                <article  className={`Hire_Text-Box ${back}`} >
                    <div>
                        <h3> 테크 스택</h3>
                        <p>식스티헤르츠는 Microservice Artchitecrue와 최신 기술 스택을 사용하여 개발하고 있습니다.</p>
                        <p>- TypeScript를 사용하여 대부분의 서비스를 개발</p>
                        <p>- Microservice Artchitecrue 기반의 설계를 적용</p>
                        <p>- Back-End 서비스 개발: Node.js / AWS Elastic Beanstalk, SQS, SNS, Lambda 등</p>
                        <p>- Front-End 서비스 개발: React.js, Next.js</p>
                        <p>- 모바일 APP 개발: React Native</p>
                    </div>
                    <div>
                        <h3> 주요 업무 </h3>
                        <p>- 확장성/생산성/안정성을 고려하여 서비스 주요 feature(API, Web, App 포함) 설계/구현/운영</p>
                        <p>- 피드 알고리즘 개발 (개인화 및 추천)</p>
                        <p>- 사용자 문제 해결을 위한 신규 피처(feature) 개발에 관한 논의에 참여</p>
                    </div>
                    <div>
                        <h3> 자격 요건 </h3>
                        <p>- 컴퓨터공학 또는 관련 학문을 전공: Data Structure, OOP, Algorithm, Database, Network 등 
