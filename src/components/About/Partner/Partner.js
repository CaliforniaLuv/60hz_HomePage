    ...
    return(
        <section className="Partner_Container">
            ...
            <div className="Partner_Box">
                ...
                <img className='Partner_Box_Img' src="./logo_png/인업스.png" alt="인업스_Logo"/>
                <img className='Partner_Box_Mobile_Inups' src="./logo_png/인업스_2.svg" alt="인업스_Mob_Logo"/>
            </div>
            <div className="Partner_Box">
                <span>
                    소셜 임팩트
                ...
                <img className='Partner_Box_Img' src="./logo_png/유쾌한반란.png" alt="유쾌한반란_Logo"/>
                <img className='Partner_Box_Mobile' src="./logo_png/유쾌한반란_2.svg" alt="유쾌한반란_Mob_Logo"/>
            </div>
        </section>
    )
}
